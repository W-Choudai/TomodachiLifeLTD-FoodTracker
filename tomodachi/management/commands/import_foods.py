...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Forward-fill merged category cells so every row has a category
        ...
        for _, row in df.iterrows():
            ...
            category_name = safe(row, "Food category", "Uncategorized")
            category, _   = FoodCategory.objects.get_or_create(name=str(category_name).strip())
